...
@section('client-content')
    <div class="container mx-auto p-3 laptop:py-10">
        ...
        <form action="{{ route('buynow.order') }}" method="post">
            @csrf
            <div class="flex flex-wrap gap-4">
                ...
                <div class="laptop:w-[40%] border rounded p-4 ">
                    ...
                    <div id="cart-table" class="mb-4">
                        ...
                        <table class="flex  justify-center">
                            ...
                            <tr>
                                ...
                                <td class="border border-black p-2 px-4 text-xs" id="Subtotal">{{ $subtotal = $price * $pqty }}৳</td>
                            </tr>
                            <tr>
                    ...
                    <input type="hidden" name="shipping" value="{{ $shipping = 70 }}">
                    ...
                    <div class="bg-[#E9E6ED] p-3 rounded">
                        ...
                        <button type="submit"
                            class="block py-3 px-3 fw-bold text-white bg-[#7F54B3] hover:bg-[#7249A4] rounded text-center mt-3 text-xs">অর্ডার
                            Confirm করুন</button>
                    </div>
